...
<template>
    <AppLayout title="Akreditasi">
        <!-- Alert -->
        <AlertDiscovery>
            <template v-slot:title> Status Akreditasi</template>
            <template v-slot:messages>
                <span v-if="notAccreditedCount === 0">
                    Seluruh unit sudah terakreditasi.
                </span>
                <span v-else>
                    Terdapat {{ notAccreditedCount }} unit yang belum
                    terakreditasi.
                </span>
            </template>
        </AlertDiscovery>
                        ...
                        >
                            ...
                            <HeaderTable>
                                ...
                                <template v-slot:description
                                    >Seluruh data akreditasi di dalam sistem
                                </template>
                            ...
                            <MainTable>
                                ...
                                <template v-slot:body>
                                    <tr
                                        v-for="accreditation in accreditations.data"
                                        :key="accreditation.id"
                                    >
                                        <td class="h-px w-px whitespace-nowrap">
                                            <div class="pl-6 py-3">
                                                <label
                                                    :for="`hs-at-with-checkboxes-${accreditation.id}`"
                                                    class="flex"
                                                >
                                                    <input
                                                        type="checkbox"
                                        ...
                                        <td class="h-px w-px whitespace-nowrap">
                                            <div class="px-6 py-1.5">
                                                <Link
                                                    :href="
                                                        route('data.units.show', accreditation.unit.code)
                                                    "
                            ...
                            <FooterTableNew
                                ...
                                :to="accreditations.to"
                                :from="accreditations.from"
                                :next-page-url="accreditations.next_page_url"
                                :prev-page-url="accreditations.prev_page_url"
                            />
                            <!-- End Footer -->
                        </div>
                    </div>
