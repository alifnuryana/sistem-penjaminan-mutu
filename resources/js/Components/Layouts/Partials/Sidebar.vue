<template>
    <div id="application-sidebar"
        ...
        <div class="px-6">
            <Link as="button" class="flex-none text-xl font-semibold dark:text-white" :href="route('dashboard')"
        ...
        <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
            <ul class="space-y-1.5">
                <li>
                    <Link as="button"
                          class="flex w-full items-center gap-x-3.5 py-2 px-2.5 bg-gray-100 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-900 dark:text-white"
